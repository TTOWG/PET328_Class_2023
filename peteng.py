...
########  A function to implement the oil material balance equation (MBE) and
# compute oil produced (np) for all blocks in a discretized reservoir,
# and returns the value total oil produced and a list of block np ########
def np(nx, ny, nz, N, Pb, bob, co, ce, boi, pi_list, pnow_list):
    # initializing output variables
    total_np = 0
    np_list = []
    # the 'for' loops
